        ...
        <div className="border rounded-lg p-5 mb-4">
          ...
          <div className="flex items-center justify-between mt-2">
            <p className="text-[16px] text-gray-100">
              Total question{markedCount === 1 ? "" : "s"} : {markedCount}
            </p>
            <span className="text-sm text-gray-400">
              <Link
                href="/marked-questions"
                className="inline-flex items-center justify-center px-[18.5px] py-2 rounded-xl text-sm font-medium text-amber-700 dark:text-amber-300 bg-amber-400/10 backdrop-blur-md border border-amber-200 hover:border-amber-200 transition-all duration-300 focus:outline-none"
              >
                View List
              </Link>
            </span>
